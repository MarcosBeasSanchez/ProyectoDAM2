        ...
        <div>
                        ...
                        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start ">
                            ...
                            <div className="hidden sm:ml-6 sm:block">
                                <div className="flex space-x-4">
                                    <a href="http://localhost:5173/register" className="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" aria-current="page">Register</a>
            ...
            <div className=" flex flex-row justify-center my-40">
                <div className="bg-zinc-800 max-w-md rounded-md p-6">
                    ...
                    <h1 className="text-white text-center font-medium  ">REGISTER</h1>
